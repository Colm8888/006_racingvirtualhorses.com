...
// Generate dynamic summary text on separate lines
    ...
    // Step Two Clear Function
function clearCalculator() {
    // Clear inputs and going fields
    document.getElementById('input_1a').value = '';
    document.getElementById('going_1').value = '';
    document.getElementById('input_2a').value = '';
    document.getElementById('going_2').value = '';
    document.getElementById('input_3a').value = '';
    document.getElementById('going_3').value = '';
    document.getElementById('input_4a').value = '';
    document.getElementById('going_4').value = '';

    // Clear result boxes
    if (document.getElementById('result_1')) document.getElementById('result_1').value = '';
    if (document.getElementById('final_1')) document.getElementById('final_1').value = '';
    if (document.getElementById('result_2')) document.getElementById('result_2').value = '';
    if (document.getElementById('final_2')) document.getElementById('final_2').value = '';
    if (document.getElementById('result_3')) document.getElementById('result_3').value = '';
    if (document.getElementById('final_3')) document.getElementById('final_3').value = '';
    if (document.getElementById('result_4')) document.getElementById('result_4').value = '';
    if (document.getElementById('final_4')) document.getElementById('final_4').value = '';
    ...
    console.log('Calculator 01 cleared!');
}